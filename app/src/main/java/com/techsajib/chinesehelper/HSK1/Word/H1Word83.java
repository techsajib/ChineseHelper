...
public class H1Word83 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word83);

        //for button section
        Button back = findViewById(R.id.w83_button1);
        Button next = findViewById(R.id.w83_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word83);
