...
public class H1Word152 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word152);

        //for button section
        Button back = findViewById(R.id.w152_button1);
        Button next = findViewById(R.id.w152_button2);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(H1Word152.this, "HSK1 is completed!", Toast.LENGTH_SHORT).show();
            }
        });

        // for HSK1 Toolbar settings here
        Toolbar toolbar = findViewById(R.id.hsk1_word152);
