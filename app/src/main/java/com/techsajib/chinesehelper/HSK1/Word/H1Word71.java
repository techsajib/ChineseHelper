...
public class H1Word71 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word71);

        //for button section
        Button back = findViewById(R.id.w71_button1);
        Button next = findViewById(R.id.w71_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word71);
