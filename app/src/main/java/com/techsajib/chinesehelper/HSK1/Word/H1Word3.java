...
public class H1Word3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word3);

        //for button section
        Button back = findViewById(R.id.w3_button1);
        Button next = findViewById(R.id.w3_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word3);
