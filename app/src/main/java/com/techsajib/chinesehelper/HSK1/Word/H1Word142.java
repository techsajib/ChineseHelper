...
public class H1Word142 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word142);

        //for button section
        Button back = findViewById(R.id.w142_button1);
        Button next = findViewById(R.id.w142_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word142);
