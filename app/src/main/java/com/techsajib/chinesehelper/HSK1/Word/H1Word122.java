...
public class H1Word122 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word122);

        //for button section
        Button back = findViewById(R.id.w122_button1);
        Button next = findViewById(R.id.w122_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word122);
