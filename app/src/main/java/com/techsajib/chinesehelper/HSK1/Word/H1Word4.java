...
public class H1Word4 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word4);

        //for button section
        Button back = findViewById(R.id.w4_button1);
        Button next = findViewById(R.id.w4_button2);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), H1Word3.class);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word4);
