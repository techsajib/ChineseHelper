...
public class H1Word54 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word54);

        //for button section
        Button back = findViewById(R.id.w54_button1);
        Button next = findViewById(R.id.w54_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word54);
