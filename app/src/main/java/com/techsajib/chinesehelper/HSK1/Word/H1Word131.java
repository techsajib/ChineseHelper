...
public class H1Word131 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word131);

        //for button section
        Button back = findViewById(R.id.w131_button1);
        Button next = findViewById(R.id.w131_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word131);
