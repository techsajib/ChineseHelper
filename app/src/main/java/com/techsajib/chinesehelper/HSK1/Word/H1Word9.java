...
public class H1Word9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word9);

        //for button section
        Button back = findViewById(R.id.w9_button1);
        Button next = findViewById(R.id.w9_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word9);
