...
public class H1Word112 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word112);

        //for button section
        Button back = findViewById(R.id.w112_button1);
        Button next = findViewById(R.id.w112_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word112);
