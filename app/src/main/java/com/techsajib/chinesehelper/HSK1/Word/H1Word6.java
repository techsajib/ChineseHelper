...
public class H1Word6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word6);

        //for button section
        Button back = findViewById(R.id.w6_button1);
        Button next = findViewById(R.id.w6_button2);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), H1Word5.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), H1Word7.class);
                startActivity(intent);
            }
        });

        // for HSK1 Toolbar settings here
        Toolbar toolbar = findViewById(R.id.hsk1_word6);
