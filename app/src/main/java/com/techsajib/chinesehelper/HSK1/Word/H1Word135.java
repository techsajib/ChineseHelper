...
public class H1Word135 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word135);

        //for button section
        Button back = findViewById(R.id.w135_button1);
        Button next = findViewById(R.id.w135_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word135);
