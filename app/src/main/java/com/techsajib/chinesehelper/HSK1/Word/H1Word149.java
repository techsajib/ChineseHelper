...
public class H1Word149 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word149);

        //for button section
        Button back = findViewById(R.id.w149_button1);
        Button next = findViewById(R.id.w149_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word149);
