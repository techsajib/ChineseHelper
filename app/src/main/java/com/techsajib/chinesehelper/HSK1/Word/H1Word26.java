...
public class H1Word26 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word26);

        //for button section
        Button back = findViewById(R.id.w26_button1);
        Button next = findViewById(R.id.w26_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word26);
