...
public class H1Word137 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.h1_word137);

        //for button section
        Button back = findViewById(R.id.w137_button1);
        Button next = findViewById(R.id.w137_button2);
        ...
        Toolbar toolbar = findViewById(R.id.hsk1_word137);
